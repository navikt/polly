...
export const getAlertEvents = async (page: number, count: number, type?: AlertEventType, level?: AlertEventLevel, processId?: string, informationTypeId?: string, disclosureId?: string) => {
