...
export const tekster: IStrings = {
  ...
  deleteProcessText: 'Er du sikker på at du vil slette behandlingen? Dersom behandlingen er opphørt skal gyldighetsperiode oppdateres.',
  ...
  deleteRelationText:'Disse koblingene må fjernes',
...
export const en: IStrings = {
  ...
  deleteProcessText: 'Are you sure you want to delete the process? If the process has been discontinued, it should instead be marked with the expiration date of the process.',
  deleteProcessorText: 'Are you sure you want to delete the processor?',
  deleteRelationText:'These connections must be removed',
