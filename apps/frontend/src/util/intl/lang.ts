...
export const no: IStrings = {
    ...
    informationTypeHasPolicies: "knyttet til {0} behandlinger",
    informationTypeHasDocuments: "knyttet til {0} dokumenter",
...
export const en: IStrings = {
    ...
    informationTypeHasPolicies: "connected to {0} processes",
    informationTypeHasDocuments: "connected to {0} documents",
