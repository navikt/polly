...
export const no: IStrings = {
  ...
  numberOfProcessesWithoutArticle6LegalBasis: "Rettslig grunnlag artikkel 6 mangler",
  numberOfProcessesWithoutArticle9LegalBasis: "Rettslig grunnlag artikkel 9 mangler",
...
export const en: IStrings = {
  ...
  numberOfProcessesWithUnknownLegalBasis: "P'rocesses with unknown legal basis",
