...
export const no: IStrings = {
  ...
  numberOfProcessesWithUnknownLegalBasis: "Antall med rettslig grunnlag uavklart",
  numberOfProcessesWithoutArticle6LegalBasis: "Antall med rettslig grunnlag artikkel 6 mangler",
  numberOfProcessesWithoutArticle9LegalBasis: "Antall med rettslig grunnlag artikkel 9 mangler",
...
export const en: IStrings = {
  ...
  numberOfProcessesWithUnknownLegalBasis: "Number of processes with unknown legal basis",
  numberOfProcessesWithoutArticle6LegalBasis: "Number of processes without article 6",
  numberOfProcessesWithoutArticle9LegalBasis: "Number of processes without article 9",
