...
export const no: IStrings = {
  ...
  retentionDescriptionPlaceHolder: 'legg inn tekst eller lenke',
  ...
  withoutArticle9LegalBasisHelpText: "Behandling av personopplysninger som anses som særlige kategorier (tidl. sensitive opplysninger) krever et ytterligere behandlingsgrunnlag iht. personopplysningsloven art. 9",
...
export const en: IStrings = {
  ...
  retentionDescriptionPlaceHolder: 'Add text or link',
  ...
  withoutArticle9LegalBasisHelpText: "Processing of personal data considered as special categories (formerly sensitive information) requires a further processing basis in accordance with the Personal Data Act Art. 9",
