...
export const no: IStrings = {
  ...
  isProcessImplemented: "Er behandlingen implementert i virskomheten?",
...
export const en: IStrings = {
  ...
  processStatusHelpText: "",
  isProcessImplemented: "Is process implemented in organization?",
  ...
  validityOfProcessHelpText: "Optional. If applicable, specify the period in which the business performed this processing. Can be left blank if you are unsure, or for ongoing processes such as case processing of various benefits.",
