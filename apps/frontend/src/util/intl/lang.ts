...
export const no: IStrings = {
  ...
  dpProcessDataProcessorYes: "Databehandleravtale inngått",
  ...
  dataProcessorAgreementPlaceholder: "(f.eks. lenke til Websak, Confluence e.l.)",
  ...
  deleteDataProcessorText:'Er du sikker på at du vil slette databehadler?',
  confirmDeleteProcessText: "Bekreft sletting av behandlingen ",
  confirmDeleteDataProcessorText: "Bekreft sletting av databehandler ",
  ...
  dataprocessorSideMenuHelpText: "Her finner du en oversikt over databehandlere",
  dashboard: "Dashboard",
...
export const en: IStrings = {
  ...
  dpProcessDataProcessorYes: "Data Processing Agreement signed",
  ...
  dataProcessorAgreementPlaceholder: "(i.e. link to Websak, Confluence etc.)",
  ...
  deleteDataProcessorText: "Are you sure you want to delete the data processor?",
  confirmDeleteProcessText: "Please confirm deleting the process ",
  confirmDeleteDataProcessorText: "Please confirm deleting the data processor ",
  ...
  dataprocessorSideMenuHelpText: "A collection of data processors",
  dashboard: "Dashboard",
