...
export const no: IStrings = {
  ...
  processNameHelpText:
    'Et kort og beskrivende navn som sier hva behandlingen går ut på. Eksempel: saksbehandling, saksbehandling sykepenger, håndtere brukerhenvendelser eller rekruttering.',
  processPurposeHelpText:
    'Hva er formålet med bruk av personopplysninger i denne behandlingen? Brukes hvis du ønsker å ha en spissere formulert formål enn det overordnede formålet. Eksempel: Behandle og vurdere rett til stønad ved behov for førerhund pga. nedsatt syn.',
