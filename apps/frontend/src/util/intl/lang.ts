...
export const en: IStrings = {
  ...
  isProcessorUsed: "Is data processor used?",
  isSubDataProcessorUsed: "Is sub data processor used?",
  processorYes: "Data processor is used",
  dpProcessProcessorYes: "Data Processing Agreement signed",
  processorNo: "Data processor is not used",
  dpProcessDataProcessorNo: "Data Processing Agreement not signed",
  processorUnclarified: "Unclarified wether data processor is used",
  dpProcessDataProcessorUnclarified: "Unclarified Data Processing Agreement",
  processorExtra: "Is a data processor used to perform the processing of personal data",
  processorAgreement: "Ref. to data processor agreement",
  ...
  deleteProcessorText: "Are you sure you want to delete the data processor?",
  confirmDeleteProcessText: "Please confirm deleting the process ",
  confirmDeleteProcessorText: "Please confirm deleting the data processor ",
  ...
  processorHelpText: "A data processor is a business that processes personal data on NAV's behalf.",
  processorAgreementHelpText: "Provide reference (i.e. case number) to the contract's storage location.",
  processorOutsideEUExtraHelpText: "Specify whether personal data is processed outside the EU / EEA area by the data processor or any sub-processors.",
  ...
  processorSideMenuHelpText: "A collection of data processors",
  dashboard: "Dashboard",
  ...
  processorSelect: "Select data processor",
  createProcessor: "Create new data processor",
  contract: "Contract",
