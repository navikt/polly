...
export const en: IStrings = {
  ...
  organizingHelpText: "Specify which department is responsible for the process. Where the process is performed in line (external agency) then specify where in the line the process is performed. If the process is supported by IT systems, specify which product teams (IT) have the management responsibility for the systems.",
