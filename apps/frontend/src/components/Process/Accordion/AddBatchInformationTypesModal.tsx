                      ...
                      render={informationTypesProps => {
                        ...
                        return <>
                          ...
                          <>
                                ...
                                <Block {...rowBlockProps}>
                                  {addable.map(it =>
                                    <Block key={it.id} display='flex' alignItems='center'
                                      ...
                                      <Button size="compact" kind="tertiary" shape="round" tooltip={intl.add}
                                              onClick={() => informationTypesProps.push(mapToUse(it))}>
                            ...
                            <LabelMedium marginTop={theme.sizing.scale600}>{intl.emptyTable} {lowerFirst(intl.informationTypes)}</LabelMedium>}
                            {!addable.length && !!infoTypes.length &&
                            <LabelMedium marginTop={theme.sizing.scale600}>{intl.all} {lowerFirst(intl.informationTypes)} {intl.added}</LabelMedium>}

                            <Block marginTop={theme.sizing.scale600} marginBottom={theme.sizing.scale600}
                                   width='100%' $style={{borderBottom: '1px solid'}}/>
                          </>}
                              ...
                              <React.Fragment key={it.informationType.id}>
                                <Block display='flex' justifyContent='space-between' alignItems='center'
                                  ...
                                  <Block width='60%' display='flex' alignItems='center'>
                                    ...
                                    />
                                    <Button marginLeft size="compact" kind="tertiary" shape="round" tooltip={intl.remove}
                                            onClick={() => informationTypesProps.remove(idx)}>
