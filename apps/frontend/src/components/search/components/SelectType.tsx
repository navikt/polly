...
export const SelectType = (props: IProps) => {
  ...
  return (
    <div className="polly-mainsearch-filter-menu text-sm absolute top-full left-0 mt-1 bg-white w-fit max-w-[calc(100vw-1rem)] rounded-(--ax-radius-12) border border-solid border-[#e6e6e6] shadow-[0px_0px_6px_3px_rgba(0,0,0,0.08)] z-50">
