...
public class InformationTypeService {
    ...
    public void validateRequests(Collection<InformationTypeRequest> requests, boolean isUpdate) {
        Map<String, Map<String, String>> validationMap = validateRequestsAndReturnErrors(requests, isUpdate);
    ...
    public Map<String, Map<String, String>> validateRequestsAndReturnErrors(Collection<InformationTypeRequest> requests, boolean isUpdate) {
        ...
        Map<String, Integer> namesUsedInRequest = new HashMap<>();

        final AtomicInteger i = new AtomicInteger(1);
        requests.forEach(request -> {
            Map<String, String> requestMap = validateRequest(request, isUpdate);
            ...
            if (!requestMap.isEmpty()) {
                validationMap.put(request.getRequestReference().orElseGet(() -> String.format("Request nr:%s", i.intValue())), requestMap);
            }
            i.getAndIncrement();
        });
    ...
    private Map<String, String> validateRequest(InformationTypeRequest request, boolean isUpdate) {
    ...
    public List<InformationType> returnUpdatedInformationTypesIfAllArePresent(Collection<InformationTypeRequest> requests) {
