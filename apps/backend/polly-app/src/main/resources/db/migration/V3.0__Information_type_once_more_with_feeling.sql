...
(
    ...
    INFORMATION_TYPE_ID UUID         PRIMARY KEY    REFERENCES INFORMATION_TYPE,
    PROCESS_ID          UUID         PRIMARY KEY    REFERENCES PROCESS,
...
CREATE INDEX INFORMATION_TYPE_IDX_NAME ON INFORMATION_TYPE ((DATA ->> 'name'::TEXT));