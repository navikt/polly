...
import no.nav.polly.common.utils.CollectionDifference;
...
import static no.nav.polly.dataset.DatacatalogMaster.GITHUB;
import static no.nav.polly.github.GithubConsumer.REFS_HEADS_MASTER;
