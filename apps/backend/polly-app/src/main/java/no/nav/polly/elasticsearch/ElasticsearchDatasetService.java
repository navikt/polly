...
import no.nav.polly.elasticsearch.domain.DatasetElasticsearch;
import no.nav.polly.policy.PolicyConsumer;
import no.nav.polly.policy.PolicyResponse;
import org.springframework.stereotype.Service;

import java.util.List;
import java.util.stream.Collectors;

import static no.nav.polly.elasticsearch.ElasticsearchStatus.SYNCED;
import static no.nav.polly.elasticsearch.ElasticsearchStatus.TO_BE_CREATED;
import static no.nav.polly.elasticsearch.ElasticsearchStatus.TO_BE_DELETED;
import static no.nav.polly.elasticsearch.ElasticsearchStatus.TO_BE_UPDATED;
