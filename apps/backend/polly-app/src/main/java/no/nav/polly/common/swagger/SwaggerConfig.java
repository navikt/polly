package no.nav.polly.common.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(Predicates.or(basePackage("no.nav.polly.codelist"),
                        basePackage("no.nav.polly.github"),
                        basePackage("no.nav.polly.dataset"),
                        basePackage("no.nav.polly.distributionchannel"),
                        basePackage("no.nav.polly.system"),
                        basePackage("no.nav.polly.kafka")
                ))
