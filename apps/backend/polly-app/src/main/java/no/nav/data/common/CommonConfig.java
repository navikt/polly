...
public class CommonConfig {
    ...
    public RestTemplate restTemplate() {
        ...
        restTemplate.setInterceptors(List.of(TraceHeaderRequestInterceptor.fullInterceptor()));
        return restTemplate;
    }
    ...
    public RestTemplate externalRestTemplate() {
        RestTemplate restTemplate = new RestTemplate();
        restTemplate.setInterceptors(List.of(TraceHeaderRequestInterceptor.correlationInterceptor()));
        return restTemplate;
    }
